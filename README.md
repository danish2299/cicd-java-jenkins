...
-------
    git clone https://github.com/danish2299/cicd-java-jenkins.git
...
--------------
    docker build -t danishbuksh2299/kubernetes-configmap-reload .
...
-----------
    docker push danishbuksh2299/kubernetes-configmap-reload
